        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                    <form class="jumbotron" method="POST" action="formulario2.php">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Número de Serie:</label>
                            <div class="col-sm-10">
                                <?php
                                $conexion = mysqli_connect("localhost", "root", "", "bd_prestamos");
                                $consulta = mysqli_query($conexion, "SELECT * FROM materiales WHERE num_serie='1234567890'");
                                $columna = mysqli_fetch_array($consulta, MYSQLI_ASSOC);
                                ?>
                                <input type="text" id="nserie" name="nserie" class="form-control" placeholder="Introduzca un número de serie..." autocomplete="off" value="<?php echo $columna["num_serie"] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Material:</label>
                            <div class="col-sm-10">
                                <input type="text" id="material" name="material" class="form-control" placeholder="Introduzca el nombre del material... (Cámara, Cable, Trípode)" autocomplete="off" value="<?php echo $columna["nombre_materiales"] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="estado" name="estado" class="form-control" placeholder="Introduzca su estado... (Modificar por valor cerrado)" autocomplete="off" value="<?php echo $columna["estado"] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
