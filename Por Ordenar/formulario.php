...
<html lang="en">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                    <form class="jumbotron" method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="nserie" name="nserie" class="form-control" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Material:</label>
                            <div class="col-sm-10">
                                <select name="materiales" id="materiales" class="form-control" autocomplete="off">
                                    <option selected disabled>Seleciona un material</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="marca" name="marca" class="form-control" placeholder="Introduzca su marca..." autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Modelo:</label>
                            <div class="col-sm-10">
                                <input type="text" id="modelo" name="modelo" class="form-control" placeholder="Introduzca su modelo..." autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Estado:</label>
                            <div class="col-sm-10">
                                <input type="text" id="estado" name="estado" class="form-control" placeholder="Introduzca su estado... (Modificar por valor cerrado)" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Observaciones:</label>
                            <div class="col-sm-10">
                                <select name="observaciones" id="observaciones" class="form-control" autocomplete="off">
                                    <option selected disabled>Seleciona una observación</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" for="ruta-imagen" id="ruta-imagen" name="ruta-imagen">
                            </div>
                        </div>
    ...
    if (isset($_POST["submit"])) {
        ...
        $nombre_materiales = strtolower($_POST['material']);
        $marca = $_POST['marca'];
        $modelo = $_POST['modelo'];
        $estado = strtolower($_POST['estado']);
        $observaciones = $_POST['observaciones'];
        $ruta = $_POST['ruta-imagen'];

        //var_dump($num_serie);
        $ruta = str_replace('\\', '\\\\', $ruta);
        $conexion = mysqli_connect("localhost", "root", "", "bd_prestamos");
        $SQL = "INSERT INTO materiales (num_serie, nombre_materiales, marca, modelo, estado, observaciones, ruta) VALUES ('$num_serie','$nombre_materiales','$marca','$modelo','$estado','$observaciones','$ruta')";
