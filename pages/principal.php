...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="navbar-nav ml-auto ">
                        <li class="nav-item active dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="./html/Materiales.html">Materiales</a>
                                <a class="dropdown-item" href="./html/Usuarios.html">Usuarios</a>
                            </div>
                        </li>
        ...
        <div class="container">
            <h1 class="titulo">ÚLTIMOS MATERIALES AÑADIDOS</h1>
            <div class="row">
            <?php
            ...
            if ($conn) {
                ...
                $resPrestamos = mysqli_query($conn, "SELECT * FROM prestamos ORDER BY fecha_prestamo DESC LIMIT 3");
                ...
                while ($columna = mysqli_fetch_array($resPrestamos, MYSQLI_ASSOC)) {
                    ...
                    $resMateriales = mysqli_query($conn, "SELECT marca, modelo FROM materiales WHERE num_serie = '$numSerie'");
                    ...
                    while ($columnaMateriales = mysqli_fetch_array($resMateriales, MYSQLI_ASSOC)) {
                        ...
                        echo "<img src=\"../img/camara.jpg\" class=\"card-img-top\" alt=\"...\">";
