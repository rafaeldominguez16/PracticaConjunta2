...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-02-2021 a las 18:04:40
...
INSERT INTO `materiales` (`num_serie`, `nombre_materiales`, `marca`, `modelo`, `estado`, `observaciones`) VALUES
...
('53535353H', '34', '2021-02-10', '2021-03-09', '2021-04-08');
...
INSERT INTO `usuarios` (`dni`, `nombre_usuarios`, `apellidos`, `curso`, `rol`, `ciclo`, `moroso`, `num_objetos`) VALUES
('1', 'pepe', 'pepe', 2, 'usuario', 'DAW', 1, 1),
('2', 'jojo', 'jojo', 1, 'usuario', 'DAM', 0, 2),
